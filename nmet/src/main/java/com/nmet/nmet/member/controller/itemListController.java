...
private static final Logger logger = LoggerFactory.getLogger(itemListController.class);
	...
	public String itemG(Locale locale, Model model) {		
		...
		List<codemngVO> list1=service.selectItem4();
		logger.info("list1={}",list1);
		List<codemngVO> list2=service.selectItem5();
		logger.info("list2={}",list2);
		model.addAttribute("clist",list);
		model.addAttribute("clist1",list1);
		model.addAttribute("clist2",list2);
	...
	@RequestMapping(value = "/member/item.do", method = RequestMethod.POST,produces="application/text; charset=UTF-8")
	...
	@RequestMapping(value = "/member/item2.do", method = RequestMethod.POST,produces="application/text; charset=UTF-8")
